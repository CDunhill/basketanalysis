...
The data was generated with the following SQL query, containing some Common Table Expressions or CTEs [NB. can't work out how to change to SQL syntax highlighting - perhaps using *knit_engines$set?*]:
